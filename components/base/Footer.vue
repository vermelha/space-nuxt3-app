...
<footer class="footer w-full text-center text-white bg-transparent z-10 bottom-0">
  <div class="container pt-6 mb-2 pb-5 mx-auto justify-between flex">
    <div class="flex justify-center">
      ...
      <a href="https://twitter.com/SPACEdotcom" class="mr-9 text-white">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://www.instagram.com/accounts/login/?next=/spacedotcom/" class="text-white">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
